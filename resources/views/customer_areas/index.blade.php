    ...
    <div class="row">
      <div class="col-sm-5">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-label-left input_mask" method="post" action="{{ url('/customer_areas') }}"
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input type="text" name="area_code" class="form-control @error('area_code') is-invalid @enderror"
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table id="basic-2" class="display expandable-table text-capitalize" style="width:100%">
                ...
                <tbody>
                  @foreach ($customer_areas as $key => $customer_area)
                    <tr>
                      <td style="width: 10%">
                        ...
                        <div class="dropdown-menu" aria-labelledby="">
                          ...
                          <a class="dropdown-item" href="#" data-bs-toggle="modal" data-original-title="test"
                            data-bs-target="#changeData{{ $customer_area->id }}">Edit</a>
                          <a class="dropdown-item" href="#" data-bs-toggle="modal" data-original-title="test"
                            data-bs-target="#deleteData{{ $customer_area->id }}">Delete</a>
                        </div>
                      </td>
                      {{-- Modul Edit UOM --}}
                      <div class="modal fade" id="changeData{{ $customer_area->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <form method="post" action="{{ url('customer_areas/' . $customer_area->id) }}"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                      ...
                                      <div class="form-group row">
                                        <div class="form-group col-md-12">
                                          ...
                                          <input type="text"
                                            ...
                                            name="area_name_edit" value="{{ $customer_area->area_name }}"
                                            placeholder="Customer Area Name" required>
                                        ...
                                        <div class="form-group col-md-12">
                                          <label>Area Code</label>
                                          <input type="text" name="area_code_edit"
                                            class="form-control @error('area_code_edit') is-invalid @enderror"
                                            value="{{ $customer_area->area_code }}" placeholder="Enter Area Code"
                                            readonly>
                                        </div>
                                      </div>
                                    </div>
                      ...
                      {{-- End Modal Edit UOM --}}
                      {{-- Modul Delete UOM --}}
                      <div class="modal fade" id="deleteData{{ $customer_area->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <form method="post" action="{{ url('customer_areas/' . $customer_area->id) }}"
                            enctype="multipart/form-data">
