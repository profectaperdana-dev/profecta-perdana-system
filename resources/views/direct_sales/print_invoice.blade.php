...
<body>
        ...
        <table style="width: 100%">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: right">@currency($data->total_excl)</td>
                </tr>
                <tr>
                    <td colspan="4" style="text-align: right">PPN {{ $ppn * 100 }}%</td>
                    <td style="text-align: right">@currency($data->total_ppn)</td>
                </tr>
                </tr>
                <tr>
                    <th colspan="4" style="text-align: right">Total</th>
                    <th style="text-align: right;border:1px solid black">@currency($data->total_incl)</th>
                </tr>
                <tr>
                    <th colspan="4">&nbsp;</th>
                    <th>&nbsp;</th>
    ...
    @if ($data->isPaid == 1)
        ...
        if (isset($pdf)) {
            ...
            $width = $pdf->get_width();
            $text = "PAID "."{{ date('d-m-Y', strtotime($data->order_date)) }}";
