        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-label-left input_mask" method="post" action="{{ url('/cars') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label class="font-weight-bold">Cars Brand</label>
                                            <input type="text"
                                                class="form-control text-capitalize {{ $errors->first('car_brand') ? ' is-invalid' : '' }}"
                                                name="car_brand" placeholder="Enter Cars Brand">
                                            @error('car_brand')
