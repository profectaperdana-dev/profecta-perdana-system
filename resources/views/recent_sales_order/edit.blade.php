    ...
    <div class="row">
      <div class="col-sm-12 col-xl-12 xl-100">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="{{ url('updateso/' . $value->id . '/editso') }}" enctype="multipart/form-data"
              id="">
              @csrf
              @method('PUT')
              <div class="container-fluid">
                    ...
                    <div class="col-md-6 form-group">
                      ...
                      <select name="customer_id" id="" required
                        ...
                        @foreach ($customer as $customer)
                          <option value="{{ $customer->id }}" @if ($customer->id == $value->customers_id) selected @endif>
                            {{ $customer->code_cust }} |
                            {{ $customer->name_cust }}
                          </option>
                        @endforeach
