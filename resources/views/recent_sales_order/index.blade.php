        ...
        $(document).on("click", ".modal-btn", function() {
          ...
          $(modal_id).on('click', '.btn-reload', function() {
            ...
            $(modal_id).find('.productSo-edit').each(function() {
              ...
              let disc = $(this).parent().siblings().find('.discount-append-edit').val() / 100;
            ...
            $(this).closest('.row').siblings().find('.ppn').val('Rp. ' + Math.round(ppn).toLocaleString('us', {
              minimumFractionDigits: 0,
              maximumFractionDigits: 0
            }));
            $(this).closest('.row').siblings().find('.total').val('Rp. ' + Math.round(total).toLocaleString(
              'us', {
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
              }));
            $(this).closest('.row').siblings().find('.total-after-ppn').val('Rp. ' + Math.round(
