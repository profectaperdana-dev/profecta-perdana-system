                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-5 col-12 col-lg-6 ">
                                <div class="fw-bold">Aktiva
                                </div>
                                <div class="fw-bold">Aktiva Lancar
                                </div>
                                <div class="">
                                    <table
                                        class=" table-bordered table-sm text-capitalize table-striped bg-light text-black"
                                        style="width:100%;border:1px solid black !important;" id="aktiva_lancar">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th class="text-nowrap">TOTAL AKTIVA LANCAR</th>
                                                <th></th>
                                                <th class="sub_total_aktiva"></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="col-lg-6 col-12 ">
                                <div>&nbsp;</div>
                                <div class="fw-bold">Aktiva Tetap
                                </div>
                                <div class="">
                                    <table
                                        class=" table-bordered table-sm text-capitalize table-striped bg-light text-black"
                                        style="width:100%;border:1px solid black !important;" id="aktiva_tetap">
                                        <thead class="text-center">
                                            <tr>
                                                <th>Code</th>
                                                <th>Account</th>
                            ...
                            <div class="mb-5 col-lg-6 col-12 ">
                                <div class="fw-bold">Pasiva
                                </div>
                                <div class="fw-bold">Kewajiban
                                </div>
                                <div class="">
                                    <table
                                        class=" table-bordered table-sm text-capitalize table-striped bg-light text-black"
                                        style="width:100%;border:1px solid black !important;" id="kewajiban">
                                        <thead class="text-center">
                                            <tr>
                                                <th>Code</th>
                                                <th>Account</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th></th>
                                                <th class="sub_total_kewajiban"></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="col-lg-6 col-12 ">
                                <div>&nbsp;</div>
                                <div class="fw-bold">Modal
                                </div>
                                <div class="">
                                    <table
                                        class=" table-bordered table-sm text-capitalize table-striped bg-light text-black"
                                        style="width:100%;border:1px solid black !important;" id="modal">
                                        <thead class="text-center">
                                            <tr>
                                                <th>Code</th>
                                                <th>Account</th>
                            ...
                            <div class="row fw-bold  mb-5 mt-0 mx-3">
                                <div class="row col-lg-6 col-12 bg-success align-items-center p-3">
                                    <div class="col-lg-6">TOTAL AKTIVA</div>
                                    <div class="col-lg-6 text-end total_aktiva"></div>
                                </div>
                                <div class="row col-lg-6 col-12 bg-info align-items-center p-3">
                                    <div class="col-lg-6">TOTAL KEWAJIBAN DAN EKUITAS</div>
                                    <div class="col-lg-6 text-end total_kewajiban"></div>
                                </div>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                function load_data(from_date = '', to_date = '', warehouse = '', show = 'all') {
                    ...
                    let aktiva_lancar = $('#aktiva_lancar').DataTable({
                        "language": {
                        ...
                        searching: false,
                        ajax: {
                            url: "{{ url('/finance/report/balance_sheet/table') }}",
                            data: {
                                from_date: from_date,
                                to_date: to_date,
                                warehouse: warehouse,
                    ...
                    let kewajiban = $('#kewajiban').DataTable({
                        "language": {
                            "processing": `<i class="fa text-success fa-refresh fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span>`,
                        },
                        "lengthChange": false,
                    ...
                    let aktiva_tetap = $('#aktiva_tetap').DataTable({
                        "language": {
                            "processing": `<i class="fa text-success fa-refresh fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span>`,
                        },
                        "lengthChange": false,
