        ...
        <tbody>
            <tr>
                <td valign="top" style="line-height: 24px; font-size: 16px; margin: 0;" align="left"
                    bgcolor="#f7fafc">
                    <table class="container-fluid" role="presentation" border="0" cellpadding="0" cellspacing="0"
                        style="width: 100%;">
                        <tbody>
                            <tr>
                                                                    ...
                                                                    <div class="space-y-3">
                                                                        <p class="text-black"
                                                                            ...
                                                                            information <span
                                                                                ...
                                                                                style="color: #ffc107; font-weight: 600 !important;">EARLY
                                                                                CHECKING</span> </p>
                                                                    ...
                                                                    <div class="row" style="margin-right: -24px;">
                                                                        <table class="" role="presentation"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="col-6"
                                                                                        style="line-height: 24px; font-size: 16px; min-height: 1px; font-weight: normal; padding-right: 24px; width: 50%; margin: 0;"
