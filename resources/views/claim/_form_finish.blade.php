<div class="row">
    <div class="col-md-12">
        <div class="form-group row font-weight-bold">
            ...
            <div class="form-group col-md-12">
                <input type="text" class="form-control bg-primary text-white text-center" placeholder="Serial Number"
                    readonly value="Finally Check">
            </div>
            <div class="col-lg-6 col-md-12 form-group">
                <label>Voltage</label>
                <input type="text" required placeholder="Enter Voltage"
                    class="form-control {{ $errors->first('f_voltage') ? ' is-invalid' : '' }}" name="f_voltage">
                @error('f_voltage')
            ...
            <div class="col-lg-6 col-md-12 form-group">
                ...
                <input type="text" placeholder="Enter CCA" required
                    class="form-control  {{ $errors->first('f_cca') ? ' is-invalid' : '' }}" name="f_cca">
                @error('f_cca')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="col-lg-6  col-md-12 form-group">
                ...
                <input type="text" required placeholder="Enter Starting"
                    class="form-control {{ $errors->first('f_starting') ? ' is-invalid' : '' }}" name="f_starting">
                @error('f_starting')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="col-lg-6 col-md-12 form-group">
                ...
                <input type="text" required placeholder="Enter Charging"
                    class="form-control {{ $errors->first('f_charging') ? ' is-invalid' : '' }}" name="f_charging">
                @error('f_charging')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
