                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group row">
                                      <div class="col-md-6">
                                        ...
                                        <input type="text"
                                          ...
                                          name="nama_supplier_" placeholder="Supplier Name" required>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        <input type="text" value="{{ old('email_', $value->email) }}"
                                          class="form-control text-capitalize {{ $errors->first('email_') ? ' is-invalid' : '' }}"
                                          name="email_" placeholder="Phone Number" required>
                                        @error('email_')
                                          <small class="text-danger">{{ $message }}.</small>
                                        @enderror
                                      </div>
                                    ...
                                    <div class="form-group row">
                                      <div class="col-md-4">
                                        ...
                                        <input type="text"
                                          ...
                                          name="npwp_supplier_" placeholder="NPWP Supplier" required>
                                      ...
                                      <div class="col-md-4">
                                        <label class="font-weight-bold">PIC
                                          Supplier</label>
                                        <input type="text" value="{{ old('pic_supplier_', $value->pic_supplier) }}"
                                          class="form-control text-capitalize {{ $errors->first('pic_supplier_') ? ' is-invalid' : '' }}"
                                          name="pic_supplier_" placeholder="PIC Supplier" required>
                                        @error('pic_supplier_')
                                          <small class="text-danger">{{ $message }}.</small>
                                        @enderror
                                      </div>
