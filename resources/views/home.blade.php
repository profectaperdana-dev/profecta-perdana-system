...
@section('content')
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-xl-6 box-col-6 des-xl-100">
        <div class="row">
            ...
            <div class="bg-primary b-r-4 card-body">
              <div class="media static-top-widget">
                ...
                <div class="media-body"><span class="m-0">Sales Goals</span>
                  <h4 class="mb-0 counter">{{ $so_by }}</h4><i class="icon-bg" data-feather="award"></i>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="bg-primary b-r-4 card-body">
              <div class="media static-top-widget">
                ...
                <div class="media-body"><span class="m-0">Verify Order Today</span>
                  <h4 class="mb-0 counter">{{ $so_verify }}</h4><i class="icon-bg" data-feather="award"></i>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="bg-primary b-r-4 card-body">
              <div class="media static-top-widget">
                ...
                <div class="media-body"><span class="m-0">Unverified orders
                    Today</span>
                  <h4 class="mb-0 counter">{{ $so_no_verif }}</h4><i class="icon-bg" data-feather="bookmark"></i>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="bg-primary b-r-4 card-body">
              <div class="media static-top-widget">
                ...
                <div class="media-body"><span class="m-0">Approve Today</span>
                  <h4 class="mb-0 counter">{{ $approve_today }}</h4><i class="icon-bg" data-feather="award"></i>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="bg-primary b-r-4 card-body">
              <div class="media static-top-widget">
                ...
                <div class="media-body"><span class="m-0">Customer Over Due Today</span>
                  <h4 class="mb-0 counter">{{ $over_due }}</h4><i class="icon-bg" data-feather="user"></i>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="bg-primary b-r-4 card-body">
              <div class="media static-top-widget">
                ...
                <div class="media-body"><span class="m-0">Total supplier</span>
                  <h4 class="mb-0 counter">{{ $supplier }}</h4><i class="icon-bg" data-feather="battery"></i>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="bg-primary b-r-4 card-body">
              <div class="media static-top-widget">
                ...
                <div class="media-body"><span class="m-0">Total Customer </span>
                  <h4 class="mb-0 counter">{{ $customer }}</h4><i class="icon-bg" data-feather="user-plus"></i>
                </div>
              </div>
            </div>
          </div>
  ...
  @push('scripts')
    ...
    <script>
      $(function() {
        ...
        var cData_po = JSON.parse(`<?php echo $data_po['chart_po']; ?>`);
        var expense = cData_po.data_po;
        var label_po = cData_po.label_po;
        var options_po = {
          series: [{
            name: 'Expense',
            type: 'area',
        ...
        var chart_po = new ApexCharts(document.querySelector("#chart-po"), options_po);
        chart_po.render();
