      ...
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown">
          ...
          <ul class="notification-dropdown onhover-show-div">
            ...
            <li class="mark-read">
              @if (count($notif) > 0)
                <p class="f-w-700 mb-0">&nbsp;<span class="notifCount pull-right badge badge-primary badge-pill">
            ...
            <div class="notifContainer">
              @foreach ($notif as $notifData)
                <li class="notif-primary">
                  <div class="media"><span class="notification-bg bg-light-primary"><i class="fa fa-envelope">
                      </i></span>
