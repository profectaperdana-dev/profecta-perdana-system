<header class="main-nav">
  <div class="sidebar-user text-center"><a class="setting-primary" href="{{ url('/profiles') }}"><i
    ...
    @else
      <img class="img-90 rounded-circle" src="{{ asset('foto_profile/' . Auth::user()->photo_profile) }}" alt="">
    @endif
        ...
        <ul class="nav-menu custom-scrollbar">
          ...
          <li class="dropdown"><a class="nav-link menu-title @if (request()->is('product_materials') ||
            ...
            <ul class="nav-submenu menu-content"
              ...
              <li>
                <a href="{{ url('/stocks') }}" class="{{ request()->is('stocks') ? 'active' : '' }}">Products
                  Stocks</a>
              </li>
              <li>
          ...
          <li class="dropdown"><a class="nav-link menu-title @if (request()->is('file_invoice') || request()->is('file_do') || request()->is('file_po')) active @endif"
            ...
            <ul class="nav-submenu menu-content"
              ...
              <li><a href="{{ url('/file_do') }}" class="{{ request()->is('file_do') ? 'active' : '' }}">File
                  Delivery
                  Order
                </a></li>
              <li><a href="{{ url('/file_po') }}" class="{{ request()->is('file_po') ? 'active' : '' }}">File
                  Purchase
                  Order</a>
              </li>
            </ul>
