...
@section('content')
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-label-left input_mask" method="post" action="{{ url('/asset_category') }}"
                                            ...
                                            <td style="width: 10%">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="">
                                                    ...
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                        ...
                                                        data-bs-target="#changeData{{ $item->id }}">Edit</a>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                        data-original-title="test"
                                                        data-bs-target="#deleteData{{ $item->id }}">Delete</a>
                                                </div>
                                            </td>
    ...
    @foreach ($asset_categories as $key => $item)
        {{-- Modul Edit UOM --}}
        <div class="modal fade" id="changeData{{ $item->id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form method="post" action="{{ url('asset_category/' . $item->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                        ...
                                        <div class="form-group row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="name_edit" value="{{ $item->name }}"
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="area_code_edit"
                                                    class="form-control @error('code_edit') is-invalid @enderror"
                                                    value="{{ $item->code }}" placeholder="Enter Category Code"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
