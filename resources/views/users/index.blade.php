            ...
            <form class="form-label-left input_mask" method="post" action="{{ url('/users') }}"
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label>Role</label>
                    <select name="role_id" class="form-control role-acc @error('role_id') is-invalid @enderror" required>
                  ...
                  <div class="form-group">
                    <label>Job</label>
                    <select name="job_id" class="form-control job-acc @error('job_id') is-invalid @enderror" required>
                  ...
                  <div class="form-group">
                    ...
                    <select name="warehouse_id"
                      class="form-control warehouse-acc @error('warehouse_id') is-invalid @enderror" required>
                                  ...
                                  <div class="form-group row">
                                    <div class="col-md-12">
                                      ...
                                      <input type="text"
                                        ...
                                        value="{{ $value->name }}" placeholder="Enter Account Name" required>
                                      @error('name_edit')
                                        <div class="invalid-feedback">
                                          {{ $message }}
                                        </div>
