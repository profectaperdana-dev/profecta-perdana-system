                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="media col-12">
                                <form class="form-inline" action="{{ url('/file_do') }}" method="get">
                                    @csrf
                                    @method('GET')
                                    ...
                                    @if ($value->pdf_do != '')
                                        <li class="file-box ">
                                            ...
                                            <div class="file-bottom">
                                                <p class="text-dark mt-1"><strong>{{ $value->pdf_do }}</strong></p>
                                        ...
                                        <div class="modal fade" id="do{{ $value->id }}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <iframe src="{{ asset('pdf/' . $value->pdf_do) }}" width="100%"
                                                            height="500px">
                                                        </iframe>
