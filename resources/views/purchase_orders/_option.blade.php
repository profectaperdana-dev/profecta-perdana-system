              ...
              <div class="row font-weight-bold">
                  ...
                  <div class="col-md-6 form-group mr-5">
                    ...
                    <select name="warehouse_id" required
                      ...
                      @foreach ($warehouses as $warehouse)
                        <option value="{{ $warehouse->id }}" @if ($purchase->warehouse_id == $warehouse->id) selected @endif>
                ...
                <div class="form-group row">
                  <div class="col-md-6 form-group mr-5">
                    ...
                    <input class="form-control" type="date" name="order_date" value="{{ $purchase->order_date }}"
                      required>
                    @error('due_date')
                      <div class="invalid-feedback">
                        {{ $message }}
                ...
                <div class="form-group row">
                  <div class="form-group col-lg-4">
                    ...
                    <input class="form-control total"
                      value="{{ 'Rp. ' . number_format($purchase->total, 0, ',', '.') }}" id="" readonly>
                  </div>
                </div>
              </div>
            </div>
