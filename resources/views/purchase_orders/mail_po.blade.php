...
<body class="bg-light"
  ...
  <table class="bg-light body" valign="top" role="presentation" border="0" cellpadding="0" cellspacing="0"
    ...
    <tbody>
      <tr>
        <td valign="top" style="line-height: 24px; font-size: 12px; margin: 0;" align="left" bgcolor="#f7fafc">
          <table class="container" role="presentation" border="0" cellpadding="0" cellspacing="0"
            style="width: 100%;">
            <tbody>
              <tr>
                <td align="center" style="line-height: 24px; font-size: 12px; margin: 0; padding: 0 12px;">
                  <!--[if (gte mso 9)|(IE)]>
                  ...
                  <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tbody>
                      <tr>
                        <td style="line-height: 24px; font-size: 12px; margin: 0;" align="left">
                          ...
                          <table class="card" role="presentation" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                              <tr>
                                <td style="line-height: 24px; font-size: 12px; width: 100%; margin: 0;" align="left"
                                  bgcolor="#ffffff">
                                  <table class="card-body" role="presentation" border="0" cellpadding="0"
                                    ...
                                    <tbody>
                                      <tr>
                                        <td
                                          style="line-height: 24px; font-size: 12px; width: 100%; margin: 0; padding: 20px;"
                                          align="left">
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td class="col-3 text-center"
                                                    style="line-height: 24px; font-size: 12px; min-height: 1px; font-weight: normal; padding-right: 24px; width: 25%; margin: 0;"
                                                    align="center" valign="top">
                                                    <img
                                                      style="width: 150px; height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; max-width: 100%; border-style: none; border-width: 0;"
                                                      class="img-fluid" src="https://id.joblum.com/uploads/30/29229.jpg"
                                          ...
                                          <table class="hr border" role="presentation" border="0"
                                            cellpadding="0" cellspacing="0"
                                            style="width: 100%; border: 1px solid #e2e8f0;">
                                            <tbody>
                                              <tr>
                                                <td
                                                  style="line-height: 24px; font-size: 12px; border-top-width: 1px; border-top-color: #e2e8f0; border-top-style: solid; height: 1px; width: 100%; margin: 0;"
                                                  align="left">
                                                </td>
                                              </tr>
                                            </tbody>
                                          ...
                                          <div class="row fw-700"
                                            ...
                                            <table class="" role="presentation" border="0" cellpadding="0"
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td class="col-12 h5 text-center"
                          ...
                          <table class="card text-sm" role="presentation" border="0" cellpadding="0"
                            cellspacing="0"
                            style="border-radius: 6px; border-collapse: separate !important; width: 100%; overflow: hidden; font-size: 14px; line-height: 16.8px; border: 1px solid #e2e8f0;"
                            bgcolor="#ffffff">
                            <tbody>
                              <tr>
                                <td style="line-height: 24px; font-size: 12px; width: 100%; margin: 0;" align="left"
                                  bgcolor="#ffffff">
                                  <table class="card-body text-sm" role="presentation" border="0"
                                    cellpadding="0" cellspacing="0"
                                    style="width: 100%; font-size: 14px; line-height: 16.8px;">
                                    <tbody>
                                      <tr>
                                        <td
                                          style="line-height: 24px; font-size: 12px; width: 100%; margin: 0; padding: 20px;"
                                          ...
                                          <table class="table thead-default  text-sm" border="0" cellpadding="0"
                                            cellspacing="0"
                                            style="width: 100%; max-width: 100%; font-size: 14px; line-height: 16.8px;">
                                            <thead>
                                              <tr>
                                                <th
                                              ...
                                              @foreach ($data->purchaseOrderDetailsBy as $key => $value)
                                                ...
                                                <tr>
                                                  ...
                                                  {{-- <td style="line-height: 24px; font-size: 12px; border-top-width: 1px; border-top-color: #e2e8f0; border-top-style: solid; margin: 0; padding: 12px;"
                                                                                                            align="right"
                                                                                                            valign="top">
                                                                                                            {{ number_format($value->productBy->harga_jual_nonretail) }}
                                                                                                        </td> --}}
                                                  <td
                                                    style="line-height: 24px; font-size: 12px; border-top-width: 1px; border-top-color: #e2e8f0; border-top-style: solid; margin: 0; padding: 12px;"
                                                    align="center" valign="top">
                                                  ...
                                                  @php
                                                    // $sub_total = $value->productBy->harga_jual_nonretail * $value->qty;
                          ...
                          {{-- <table class="card" role="presentation" border="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 12px; width: 100%; margin: 0;"
