...
<div class="dropdown-menu" aria-labelledby="">
    ...
    <a class="dropdown-item modal-btn2" href="#" data-bs-toggle="modal" data-original-title="test"
        data-bs-target="#manageData{{ $vacation->id }}">Action</a>
</div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-light table-stripped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="task_desc_0 fw-bold {{ ($vacation->employeeBy->vacation >= 1 ) ? 'text-success' : 'text-danger' }}">{{ $vacation->employeeBy->vacation }}</p>
                                    </td>
                                </tr>
