    ...
    <div class="info-pembayaran">
        ...
        <table style="width:100%">
            ...
            <tr>
                ...
                <td colspan="2" class="text-start">
                    {{ ' : ' . $data->customerBy->code_cust . ' - ' . $data->customerBy->name_cust }} </td>
            </tr>
            <tr>
                <td>Status</td>
        ...
        <table style="width:100%">
            ...
            <tbody style="border-top: 1px solid black;">
                ...
                @foreach ($data->salesOrderCreditsBy as $detail)
                    <tr>
            ...
            <tfoot>
                <tr style="border-top: 1px solid black;">
                    ...
                    <td style="text-align: right">
                        {{ number_format($data->salesOrderCreditsBy->sum('amount'), 0, ',', '.') }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        {{ number_format($data->total_after_ppn - $data->salesOrderCreditsBy->sum('amount'), 0, ',', '.') }}
                    </td>
                </tr>
            </tfoot>
        </table>
