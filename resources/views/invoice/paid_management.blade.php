          ...
          <div class="card-body">
            ...
            <div class="form-group row col-12">
              ...
              <div class="col-4">
                ...
                <div class="input-group">
                  <input class="form-control digits" type="date" data-language="en" placeholder="Start" name="to_date"
                    id="to_date">
                </div>
              </div>
              <div class="col-2">
            ...
            <div class="table-responsive">
              <table id="example1" class="display table-bordered expandable-table text-capitalize table-hover"
                style="width:100%">
                <thead>
                  <tr>
      ...
      $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
          $('#example1').DataTable({
            ...
            serverSide: true,
            ajax: {
              url: "{{ url('/invoice/manage_payment') }}",
              data: {
                from_date: from_date,
                to_date: to_date
              }
            ...
            buttons: ['pageLength',
              {
                title: ' Data Unpaid Invoice Profecta Perdana in {{ Auth::user()->warehouseBy->warehouses }}',
                extend: 'print',
