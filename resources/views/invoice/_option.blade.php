<a class="btn btn-sm btn-primary" href="javascript:void(0)" data-bs-toggle="modal"
  data-bs-target="#markData{{ $invoice->$id }}">Mark</a>
        ...
        <div class="container-fluid">
          <div class="form-group row">
            <div class="col-md-6 form-group">
              <label>
                Customers</label>
              <input type="text" class="form-control" readonly value="{{ $invoice->customerBy->name_cust }}">
            ...
            @foreach ($value->salesOrderDetailsBy as $detail)
              <div class="form-group row">
                ...
                <div class="col-2 col-md-2 form-group">
                  <label>Qty</label>
                  <input type="number" class="form-control cekQty-edit" name="editProduct[{{ $loop->index }}][qty]"
                    value="{{ $detail->qty }}" />
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-4 form-group">
              ...
              <input class="form-control total-after-ppn" value="{{ 'Rp. ' . number_format($value->total_after_ppn) }}"
                readonly>
            </div>
          </div> --}}
          </div>
