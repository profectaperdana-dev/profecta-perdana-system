            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group">
                            <label>
                                Ref. Invoice Number</label>
                            <input type="text" readonly value="{{ $invoice->direct_number }}" class="form-control">
                        </div>
                        <div class="col-lg-6 form-group">
                            <label>
                                Warehouse</label>
                    ...
                    <div class="btn-group dropup">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" target="popup"
                                    onclick="window.open('{{ url('material-promotion/transaction/' . $invoice->id . '/delivery_order') }}','name','width=600,height=400')
                                    ">Delivery
                                    Order</a></li>
                            <li>
                            ...
                            <li><a class="dropdown-item" target="popup"
                                    onclick="window.open('{{ url('material-promotion/transaction/' . $invoice->id . '/delivery_order_struk') }}','name','width=600,height=400')
                                ">Delivery
                                    Order Struk</a></li>
                        </ul>
                    </div>
                    <div class="btn-group dropup">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item"
                                    href="{{ url('material-promotion/return/' . $invoice->id . '/create') }}">Return
                                    Invoice</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
