                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-6">
                                <label class="col-form-label text-end">From</label>
                                <div class="input-group">
                                    <select name="material" id="from_warehouse" class="form-control selectMulti" multiple>
                                        {{-- <option value="" selected>--ALL--</option> --}}
                                        @foreach ($all_warehouse as $row_warehouse)
                            ...
                            <div class="col-lg-4 col-6">
                                <label class="col-form-label text-end">To</label>
                                <div class="input-group">
                                    <select name="material" id="to_warehouse" class="form-control selectMulti" multiple>
                                        {{-- <option value="" selected>--ALL--</option> --}}
                                        @foreach ($all_warehouse as $row_warehouse)
                                            <option value="{{ $row_warehouse->id }}">
                                                {{ $row_warehouse->warehouses }}
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                function load_data(from_date = '', to_date = '', type = '', product = '', material = '', group = '',
                ...
                $('#filter').click(function() {
                    ...
                    if (from_date != '' && to_date != '') {
                        load_data(from_date, to_date, type, product, material, group, from_warehouse,
                            to_warehouse);
                    } else {
                        $.notify({
                            title: 'Warning !',
                ...
                $('#refresh').click(function() {
                    ...
                    $('#form_warehouse').val('').trigger('change');
