...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 col-12">
                                <label class="col-form-label text-end">Customers</label>
                                <div class="input-group">
 ...
 <div class="col-lg-3 col-12">
                                <label class="col-form-label text-end">Payment</label>
                                <div class="input-group">
                                    <select  id="payment" multiple class="form-control selectMulti">
                                            <option value="Cash">
                                                Cash
                                            </option>
                            ...
                            <table style="font-size: 10pt" id="dataTable" class="stripe row-border order-column table-sm"
                                ...
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th>Customer</th>
                                        <th>Settlement Period (Day)</th>
                                        <th>Payment Recipient</th>
                                        <th>Payment Method</th>
                                        <th style="text-align:center !important;">Amount Total</th>
                                        <th style="text-align:center !important;">Payment Amount</th>
                                        <th style="text-align:center !important;">Remaining</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                function load_data(from_date = '', to_date = '', customer = '', area = '', category = '',payment='') {
                    ...
                    var table = $('#dataTable').DataTable({
                        ...
                        destroy: true,
                        ajax: {
                            url: "{{ url('/report_settlement_direct') }}",
                            data: {
                                from_date: from_date,
                                to_date: to_date,
                                customer: customer,
                ...
                $('#filter').click(function() {
                    ...
                    if (from_date != '' && to_date != '') {
                        load_data(from_date, to_date, customer, area, category,payment);
                    } else {
                        $.notify({
                            title: 'Warning !',
