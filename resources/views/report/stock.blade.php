                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-12 form-group">
                                <label class="col-form-label text-end">Choose Date</label>
                                <div class="input-group">
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                //Datatable stock
                function load_data(from_date = '', warehouse = '', type = '', product = '', material =
                    '') {
                ...
                $('#filter').click(function() {
                    ...
                    if (from_date != '') {
                        load_data(from_date, warehouse, type, product, material);
