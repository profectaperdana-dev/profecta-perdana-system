            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h6 class="font-weight-normal mb-0 breadcrumb-item active">
                        You can receive stock mutations.
                    </h6>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Receive Mutation
                            :
                            {{ $mutation->mutation_number }}</h5>
                        <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ url('stock_mutation/' . $mutation->id . '/receive_mutation') }}" method="POST"
