        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 20%">
                    ...
                    : {{ $data->secondSaleBy->second_sale_number }}<br>
                </td>
            </tr>

            <tr>
                <th colspan="5" style="text-align: center;border-top:1px solid black ">RETURN TRADE-IN SALES

                </th>
            </tr>
            <tr>
                <td colspan="5" style="width: 90%;text-align:left">Return by customer : <br>
                    {{ $data->secondSaleBy->customer_name . ' - ' . $data->secondSaleBy->customer_phone }} <br>
                ...
                @foreach ($data->returnDetailsBy as $key => $value)
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;">
                            {{ $value->productBy->name_product_trade_in }}&nbsp;
        ...
        <footer>
            <table style="width: 100%">
                <thead>
                    ...
                    <tr>
                        <th style="text-align: center;width: 33%"><i>( {{ $data->created_by->name }} )</i> </th>
                        <th style="width: 33%">&nbsp;</th>
                        <th style="width: 33%">&nbsp;</th>
                    </tr>
                </thead>
