<div class="row">
    <div class="col-md-12">
        <div class="" id="formReturn">
            ...
            @foreach ($trade_in->second_sale_details as $item)
                <div class="row rounded pt-2 mb-3 mx-auto" style="background-color: #f0e194">
                    <div class="form-group col-12 col-lg-7">
                        ...
                        <select multiple name="returnFields[{{ $loop->index }}][product_id]"
                            ...
                            <option value="{{ $item->product_second_id }}" selected>
                                {{ $item->secondProduct->name_product_trade_in }}
                            </option>
                        </select>
...
{{-- <div class="row">
    <div class="col-md-12">
        <div class="row" id="formReturn">
            <input type="hidden" name="po_id" value="{{ $trade_in->id }}" id="po_id">
            @foreach ($trade_in->second_sale_details as $item)
                <div class="row bg-primary rounded pt-2 mb-3">
                    <div class="form-group col-12 col-lg-7">
                        <label>Product</label>
        ...
        <div class="form-group">
            <a class="btn btn-danger" href="{{ url('/all_purchase_orders') }}"> <i class="ti ti-arrow-left"> </i>
                Back
            </a>
            <button type="reset" class="btn btn-warning">Reset</button>
            <button type="submit" class="btn btn-primary">Create</button>
