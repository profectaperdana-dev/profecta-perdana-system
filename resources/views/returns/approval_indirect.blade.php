        ...
        <script>
            $(document).ready(function() {
                $(document).on("click", ".modal-btn2", function(event) {
                    ...
                    // Set the value of the input element
                    let return_date = $(modal_id).find('input[name=return_date]').attr('data-value');
                    return_date = new Date(return_date);
                    $(modal_id).find('input[name=return_date]').val(parseDate(return_date));

                    $(modal_id).find('#addReturn').unbind('click');
                    let old_reason = $(modal_id).find('.return_reason1').val();
                    $(modal_id).find('.return_reason1').change(function() {
                        let return_reason1 = $(this).val();
                        if (return_reason1 == old_reason[0]) {
