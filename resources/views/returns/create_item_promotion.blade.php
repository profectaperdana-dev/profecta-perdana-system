            ...
            <div class="col-sm-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ url('material-promotion/return/store') }}"
                            enctype="multipart/form-data">
                            @csrf
                            @include('returns._form_item_promotion')
                        </form>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(".productReturn").select2({
                    ...
                    ajax: {
                        type: "GET",
                        url: "/material-promotion/selectReturn",
                ...
                $(document).on('change', '.productReturn', function() {
                    product_id = $(this).val();
                    console.log($(this).parent().siblings().find(".price").html());
                    $(this).parent().siblings().find(".price").select2('destroy');

                    $(this).parent().siblings().find(".price").select2({
                        placeholder: 'Select the price',
                        allowClear: true,
                        maximumSelectionLength: 1,
                        width: '100%',
                    ...
                    $(this).closest('.row').find(".price").on('change', function() {
                        let current_price = $(this).val();
                        $.ajax({
                            context: this,
                            type: "GET",
                            url: "/material-promotion/selectQtyReturn",
                            data: {
                                _token: csrf,
                                s: so_id,
                                p: product_id,
                ...
                $("#addReturn").on("click", function() {
                    ...
                    let form =
                        ...
                        '<label>Price</label>' +
                        '<select multiple name="returnFields[' + x + '][price]" id=""' +
