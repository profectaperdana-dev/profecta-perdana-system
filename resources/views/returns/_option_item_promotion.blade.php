        ...
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">
                    ...
                    <div class="text-success">
                        ...
                        {{ $return->transactionBy->order_number }}
                    </div>
                </h6>
                        ...
                        <div class="font-weight-bold">
                            <div class="form-group row">
                                <div class="form-group col-12 col-lg-6">
                                    ...
                                    <input type="text"
                                        value="{{ $return->transactionBy->customerBy->name_cust . ' - ' . $return->transactionBy->customerBy->code_cust }}"
            ...
            <div class="modal-footer">
                <button class="btn btn-info" target="popup"
                        onclick="window.open('{{ url('material-promotion/return/' . $return->id . '/print') }}','name','width=600,height=400')">Print</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a type="button" href="{{ url('material-promotion/return/' . $return->id . '/delete') }}"
