    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" href="{{ url('return_trade_in_sale/delete/return_trade_in/' . $return->id) }}"
            ...
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel">
                    ...
                    <div>
                        ...
                        {{ $return->secondSaleBy->second_sale_number }}
                    </div>
                </h6>
            </div>
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button class="btn btn-info" target="popup"
                            onclick="window.open('{{ url('return_trade_in_sale/' . $return->id . '/print') }}','name','width=600,height=400')">Print</button>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ url('return_trade_in_sale/' . $return->id . '/update_return') }}" method="POST"
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <input type="hidden" id="po_id" value="{{ $return->secondSaleBy->id }}">
