        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 20%">
                    ...
                    : {{ $data->transactionBy->order_number }}<br>
                </td>
            </tr>

            <tr>
                <th colspan="6" style="text-align: center;border-top:1px solid black ">RETURN MATERIAL PROMOTION

                </th>
            </tr>
            <tr>
                <td colspan="6" style="width: 90%;text-align:left">Return from : <br>
                    {{ $data->transactionBy->customerBy->name_cust }} -
                    {{ $data->transactionBy->customerBy->code_cust }}
                    <br>
                    {{ $data->transactionBy->customerBy->address_cust }} <br>
