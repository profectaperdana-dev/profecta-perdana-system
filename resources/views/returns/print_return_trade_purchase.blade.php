        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 20%;text-align:left">
                    Date <br>
                    Return<br>
                    Trade-In Purchase <br>
                </td>
                <td style="width: 20%">
                    : {{ date('d F Y', strtotime($data->return_date)) }} <br>
                    : {{ $data->return_number }}<br>
                    : {{ $data->TradeInBy->trade_in_number }}<br>

                </td>
            </tr>

            <tr>
                <th colspan="5" style="text-align: center;border-top:1px solid black ">RETURN TRADE-IN PURCHASE

                </th>
            </tr>
            <tr>
                <td colspan="5" style="width: 90%;text-align:left">Return reference : <br>
                    {{ $data->TradeInBy->retail_order_number }} <br>
