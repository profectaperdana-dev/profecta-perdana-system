        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-label-left input_mask" method="post" action="{{ url('/warehouse_types') }}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label class="font-weight-bold">Warehouse Type</label>
                                            <input type="text"
                                                class="form-control text-capitalize {{ $errors->first('name') ? ' is-invalid' : '' }}"
                                                name="name" placeholder="Warehouse Type" required>
                                            @error('name')
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text"
                                                class="form-control text-capitalize {{ $errors->first('detail') ? ' is-invalid' : '' }}"
                                                name="detail" placeholder="Description" required>
                                            @error('detail')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
    ...
    @foreach ($data as $key => $value)
        ...
        <div class="modal fade" id="changeData{{ $value->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <form method="post" action="{{ url('warehouse_types/' . $value->id) }}" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="form-group row font-weight-bold">
                                        <div class="col-md-12 form-group">
                                            <label class="font-weight-bold">Name
                                                Warehouses Type</label>
                                            <input type="text"
                                                class="form-control text-capitalize {{ $errors->first('name_') ? ' is-invalid' : '' }}"
                                                name="name_" value="{{ $value->name }}" placeholder="Name Warehouses"
                                                required>
                                            @error('name_')
                                                <small class="text-danger">{{ $message }}.</small>
                                            @enderror
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label class="font-weight-bold">Description</label>
                                            <input type="text"
                                                class="form-control text-capitalize {{ $errors->first('detail_') ? ' is-invalid' : '' }}"
                                                name="detail_" value="{{ $value->detail }}"
