                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label class="font-weight-bold">Name Type Warehouse</label>
                                            <input type="text"
                                                class="form-control text-capitalize {{ $errors->first('name') ? ' is-invalid' : '' }}"
                                                name="name" placeholder="Name Warehouses Types" required>
                                            @error('name')
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text"
                                                ...
                                                name="detail" placeholder="Name Warehouses Types" required>
                                            @error('detail')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <div class="modal fade" id="changeData{{ $value->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <form method="post"
                                                        action="{{ url('warehouse_types/' . $value->id) }}"
                                                        enctype="multipart/form-data">
                                                        @csrf
