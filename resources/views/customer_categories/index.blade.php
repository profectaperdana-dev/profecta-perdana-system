                                        ...
                                        <tbody>
                                            @foreach ($customer_categories as $customer_category)
                                                <tr>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item" href="#" data-toggle="modal"
                                                                    data-target="#editModal{{ $customer_category->id }}">Edit</a>
                                                                <a class="dropdown-item" href="#" data-toggle="modal"
                                                                    data-target="#delModal{{ $customer_category->id }}">Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <!-- Delete Modal -->
                                                    <div class="modal fade" id="delModal{{ $customer_category->id }}"
                                                        tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
