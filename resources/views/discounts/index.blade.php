                  ...
                  <div class="form-group row">
                    <div class="form-group col-md-12">
                      ...
                      <select name="customer_id" id="customer"
                        class="form-control discount @error('customer_id') is-invalid @enderror" required>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table id="discount-table" class="display expandable-table text-capitalize" style="width:100%">
                <thead>
                  <tr>
                ...
                <tbody>
                  @foreach ($discounts as $key => $discount)
                    <tr>
                      ...
                      {{-- Modul Edit Discount --}}
                      <div class="modal fade" id="changeData{{ $discount->id }}" tabindex="-1" role="dialog"
                              ...
                              <div class="modal-body">
                                <div class="container-fluid">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="form-group col-md-6">
                                      <label>Discount</label>
                                      <input type="number" name="discount_edit" id="discount"
                                        class="form-control @error('discount_edit') is-invalid @enderror"
                                        placeholder="Enter Discount" value="{{ $discount->discount }}" required>
                                      @error('discount_edit')
                                        <div class="invalid-feedback">
                                          {{ $message }}
                                        </div>
                      ...
                      <div class="modal fade" id="deleteData{{ $discount->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <form method="post" action="{{ url('discounts/' . $discount->id) }}"
                            enctype="multipart/form-data">
