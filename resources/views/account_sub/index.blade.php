        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-label-left input_mask" method="post" action="{{ url('/account_sub') }}"
                                ...
                                <div class="col-md-12" id="formdynamic">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control uoms" name="account_id" required>
                                ...
                                <tbody>
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            {{-- <td>{{ $key + 1 }}</td> --}}
                                            <td>{{ $value->code }}</td>
                                            <td>{{ $value->account->name }} / {{ $value->name }}</td>
                                            <td style="width: 10%">
    ...
    @foreach ($data as $key => $value)
        ...
        <div class="modal fade" id="changeData{{ $value->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <form method="post" action="{{ url('account_sub/' . $value->id) }}" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-control uoms" name="account_ids">
                                            ...
                                            @foreach ($account as $val)
                                                <option value="{{ $val->id }}"
                                                    @if ($val->id == $value->account_id) selected @endif>
                                                    ({{ $val->code }})
                                                    {{ $val->name }}
                                                </option>
                                            @endforeach
