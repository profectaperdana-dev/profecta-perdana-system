        ...
        <script>
            ...
            $("#addSo").on("click", function() {
                ...
                let form =
                    ...
                    x +
                    '][product_id]" class="form-control productSo2" required>' +
                ...
                //let set_product = [...new Set(list_product)];
                let set_product = [...new Set(list_product)];
                //select2 product
                $(".productSo2").select2({
                    width: "100%",
                    ajax: {
                        type: "GET",
                        url: "{{ url('/products/select_without') }}",
                        data: {
                            _token: csrf,
                            data: set_product
                        },
                ...
                $(document).on("change", ".productSo2", function() {
                    product_id = $(this).val();
