                      ...
                      @foreach ($dataInvoice as $value)
                        <tr>
                          ...
                          <td class="text-center"><a class="btn btn-primary btn-sm" href="#" data-bs-toggle="modal"
                              data-original-title="test" data-bs-target="#detailData{{ $value->id }}">Approval
                          </td>
                          </a>
                        </tr>
                            ...
                            <form>
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <a href="{{ url('/sales_orders/approve/' . $value->id) }}"><button
                                      class="btn btn-primary" type="submit">Yes, approve
                                    </button></a>
                                </div>
                            </form>
                          </div>
