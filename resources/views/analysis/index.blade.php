                                ...
                                <div class="card-header">
                                    ...
                                    <div class="form-group row mt-2">
                                        ...
                                        <div class="col-6 col-lg-2">
                                            <label class="col-form-label text-end">&nbsp;</label>
                                            <div class="input-group">
                                                <button class="btn btn-primary btn-sm form-control text-white"
                                                    name="filter" id="filter-product"><i
                                        ...
                                        <div class="col-6 col-lg-2">
                                            <label class="col-form-label text-end">&nbsp;</label>
                                            <div class="input-group">
                                                <a class="btn btn-warning btn-sm form-control text-white"
                                                    href="{{ url('/analytics') }}"><i class="fa fa-refresh"
                                                        aria-hidden="true"></i>
                                                </a>
                                            </div>
                                        </div>
