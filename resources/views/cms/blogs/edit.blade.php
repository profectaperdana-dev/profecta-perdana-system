                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('publish') }}" method="POST" id="formblog" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $content->id }}" id="id-blog">
                            <div>
                                ...
                                background-image: url({{ $content->img_header ? url('public/images/cms/blogs/' . $content->img_header) : asset('images/no-image.png') }});">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-lg" type="text" placeholder="Title here..."
                                    name="title" id="titleinput" value="{{ $content->title }}" required>
                            </div>
                                ...
                                <select name="category_id" id="categoryinput" required class="form-control selectMulti"
                                    ...
                                    @foreach ($categories as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == $content->category_id) selected @endif>{{ $item->name }}</option>
                                    @endforeach
                                    {{-- <option value="1">coba</option> --}}
                                </select>
                            </div>
                            <textarea id="write-area" placeholder="Write here..." name="content_publish">{{ $content->article }}
                            </textarea>
                            <div class="mt-3">
