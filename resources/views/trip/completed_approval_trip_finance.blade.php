        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.modalItem', function() {
                    ...
                    $(modal_id).find('.expand').on('click', function() {
                        let status_hidden = $(this).next('.expand-advance');
                        if (status_hidden.is(':hidden')) {
                            $(this).html('<i class="fa fa-caret-up" aria-hidden="true"></i>');
                            $(this).next('.expand-advance').attr('hidden', false);
                        } else {
                            $(this).html('<i class="fa fa-caret-down" aria-hidden="true"></i>');
                            $(this).next('.expand-advance').attr('hidden', true);
                    ...
                    $(modal_id).find('.acomodation,.transport,.perDiem,.other').on('focusout',
                        function() {
                            ...
                            console.log('akomodasi :' + totalAcomodation)

                            let totalPerDiem = $(modal_id).find('.totalPerDiem_').val();
                            console.log('diem :' + totalPerDiem)
                    ...
                    let y = $(modal_id).find('#table-body' + item_id).attr('data-count');
                    ...
                    $(document).on('click', '.addRow', function() {
                        ...
                        <tr>
                                        ...
                                        <td><input name="expense[${y}][date]" class="datepicker-here form-control digits"
                                                    data-position="top left" type="text" data-language="en"
                                                    data-value="{{ date('d-m-Y') }}" autocomplete="on"></td>
                                        <td>
                                            <textarea class="form-control" name="expense[${y}][desc]" id="" cols="30" rows="1"></textarea>
                                        </td>
                                        <td><input placeholder="0"
                                                class="transport form-control text-end" type="text" value="0">
                                            <input value="0" type="hidden" class="realTransport" name="expense[${y}][transport]">
                                        </td>
                                        <td><input placeholder="0"
                                                class="acomodation form-control text-end" type="text" value="0">
                                            <input value="0" type="hidden" class="realAcomodation" name="expense[${y}][acomodation]">
                                        </td>
                                        <td><input placeholder="0"
                                                class="perDiem form-control text-end" type="text" value="0">
                                            <input value="0" type="hidden" class="realPerDiem" name="expense[${y}][per_diem]">
                                        </td>
                                        <td><input placeholder="0"
                                                class="other form-control text-end" type="text" value="0">
                                            <input value="0" type="hidden" class="realOther" name="expense[${y}][other]">

                                        </td>

                                        </tr>
                         `;
                        $(modal_id).find('#table-body' + item_id).append(newRow);
                        $(modal_id).find('#table-body' + item_id).find('tr:last').find(
                            '.datepicker-here').datepicker({
                            onSelect: function(formattedDate, date, inst) {
                                inst.hide();
                            },
            ...
            $(document).ready(function() {
                ...
                function load_data() {
                    ...
                    var table = $('#outside').DataTable({
                        ...
                        destroy: true,
                        ajax: {
                            url: "{{ url('trip/completed/finance_approval') }}",
